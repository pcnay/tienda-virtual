<?php
	...
	class Notas extends Controllers
	{
		public function __construct()
		{
			...
			// "getPermisos(10)" -> Para extraer los permisos que corresponde al modulo en el momento, para este caso es el 10 (Notas)
			getPermisos(10); // Este el Id que corresponde en la tabla de Notas; 10 = Notas
		}
		...
		public function Notas()
		{
			...
			$data['page_tag'] = "Notas";
			$data['page_title'] = "NOTAS <small>Control De Responsivas</small>";
			...
			if ($_SESSION['permisosMod']['w'])
				{
					...
					if ($_POST)
					{
						...
						else
						{
							...
							// $intId_Persona = intval($_POST['idPersona']); // ID del usuario que inicia la sesion.
		
							$intId_Persona = 1; // ID del usuario que inicia la 							
