...
CREATE TABLE `t_Imagen` (
  ...
  KEY `productoid` (`productoid`),
  CONSTRAINT `t_Imagen_ibfk_1` FOREIGN KEY (`productoid`) REFERENCES `t_Productos` (`id_producto`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `t_Imagen`
--

LOCK TABLES `t_Imagen` WRITE;
/*!40000 ALTER TABLE `t_Imagen` DISABLE KEYS */;
INSERT INTO `t_Imagen` VALUES (9,7,'pro_311a5cd614854d58ea1abd4f41497c1b.jpg'),(10,7,'pro_0a922b0ceb5cdf3a755812ae6edfe1f3.jpg');
/*!40000 ALTER TABLE `t_Imagen` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_Permisos` VALUES (608,3,1,1,0,0,0),(609,3,2,1,1,1,1),(610,3,3,1,1,1,0),(611,3,4,1,1,1,0),(612,3,5,0,0,0,0),(613,3,6,1,1,1,0),(614,2,1,0,0,0,0),(615,2,2,0,0,0,0),(616,2,3,0,0,0,0),(617,2,4,1,1,1,1),(618,2,5,0,0,0,0),(619,2,6,0,0,0,0),(632,1,1,1,0,0,0),(633,1,2,1,1,1,1),(634,1,3,1,1,1,1),(635,1,4,1,1,1,1),(636,1,5,0,0,0,0),(637,1,6,1,1,1,1),(638,4,1,0,0,0,0),(639,4,2,0,0,0,0),(640,4,3,1,1,1,1),(641,4,4,0,0,0,0),(642,4,5,0,0,0,0),(643,4,6,0,0,0,0);
...
INSERT INTO `t_Productos` VALUES (7,1,'023563','Producto 1','Descripcion Producto 1',568.00,10,NULL,'2022-11-14 20:23:57',1),(8,3,'520120','Producto 2','Descripcion Producto 2',23.00,5,NULL,'2022-11-14 20:43:31',1),(9,4,'20202','Producto 3','Descripcion Producto 3',15.00,2,NULL,'2022-11-14 20:45:14',1),(10,6,'5689756','Producto 4','<p>Descripcion Producto 4</p>',145.00,3,NULL,'2022-11-14 21:00:02',1),(11,6,'7456896','Producto 5','<p>Descripcion Producto 5</p>',18.00,2,NULL,'2022-11-14 21:05:21',1),(12,6,'6589523','Producto 6','<p>Descripcion Producto 6</p>',42.00,4,NULL,'2022-11-14 22:14:23',1),(13,7,'895326','Producto 7','<p>Descripcion Producto 7</p> <table style=\"border-collapse: collapse; width: 100%;\" border=\"1\"> <tbody> <tr> <td style=\"width: 97.8644%;\">&nbsp;</td> </tr> </tbody> </table>',15.00,7,NULL,'2022-11-14 22:31:52',1);
...
-- Dump completed on 2022-11-22 23:37:23
