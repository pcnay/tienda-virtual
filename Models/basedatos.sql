...
CREATE DATABASE IF NOT EXISTS bd_responsivas2;
...
CREATE USER 'usuario_responsiva2'@'localhost' IDENTIFIED BY 'Responsiva2_2024';
GRANT ALL on bd_responsivas2.* to 'usuario_responsiva2'  IDENTIFIED BY 'Responsiva2_2024';
*/
...
CREATE TABLE t_Cinta
(
	id_cinta SMALLINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,	
	id_persona SMALLINT UNSIGNED NOT NULL,
	num_serie VARCHAR(30) NOT NULL,
	nombre VARCHAR(100) DEFAULT NULL,
	fecha DATE DEFAULT NULL,
	localizacion VARCHAR(30) DEFAULT NULL,
	tiempo_respaldo VARCHAR(30) DEFAULT NULL,
	identificador VARCHAR(30) DEFAULT NULL,
	secuencia VARCHAR(30) DEFAULT NULL,
	ubicacion_origen VARCHAR(50) DEFAULT NULL,
	comentarios TEXT,
...
CREATE TABLE t_Detalle_Pedidos		// Borrar
(
...
CREATE TABLE t_Detalle_Temp			// Borrar
(
  id_detalle_pedido INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
	productoid INT UNSIGNED NOT NULL,	
	cantidad SMALLINT UNSIGNED,
