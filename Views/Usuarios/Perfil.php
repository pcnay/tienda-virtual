      ...
      <div class="row user">
        ...
        <div class="col-md-9">
          <div class="tab-content">						
            ...
            <div class="tab-pane active" id="user-timeline">
              <div class="timeline-post">
                <div class="post-media">
                  <div class="content">
                    <h5>DATOS PÉRSONALES <button class="btn btn-sm btn-info" type="button" onclick="openModalPerfil();"><i class="fas fa-pencil-alt" aria-hidden="true"></i></button></h5>                    
                  </div>
                </div>
            ...
            <div class="tab-pane fade active" id="user-settings">
