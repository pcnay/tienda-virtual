...
<!-- Modal -->
<div class="modal fade" id="modalFormModulo" name = "modalFormModulo" tabindex="-1" role="dialog"  aria-hidden="true">
					...
					<div class= "row">
						<div class="col-md-6"> 
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" id ="txtNombre" name = "txtNombre" placeholder="Nombre Modulo" maxlength="50" required="">
							</div>
							<div class="form-group">
								<label class="control-label">Descripcion<span class = "required">*</span></label>
								<textarea class="form-control" rows="2" id = "txtDescripcion" name = "txtDescripcion" placeholder="Descripcion Del Modulo" required =""></textarea>
							</div>
...
<!-- Modal -->
<div class="modal fade" id="modalViewModulo" name = "modalViewModulo" tabindex="-1" role="dialog"  aria-hidden="true">
