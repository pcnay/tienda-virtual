...
<!-- Modal -->
<div class="modal fade" id="modalFormModelo" name = "modalFormModelo" tabindex="-1" role="dialog"  aria-hidden="true">
					...
					<div class= "row">
						<div class="col-md-6"> 
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" id ="txtDescripcion" name = "txtDescripcion" placeholder="Nombre Modelo" maxlength="45" required="">
							</div>
...
<!-- Modal -->
<div class="modal fade" id="modalViewModelo" name = "modalViewModelo" tabindex="-1" role="dialog"  aria-hidden="true">
