...
<?php headerAdmin($data);
			getModal('ModalDeptos',$data);	// Para mostrar el Modal.
?>
	...
	<!-- Sidebar menu-->
		<div class="app-title">
			...
			<ul class="app-breadcrumb breadcrumb">
				...
				<!-- /Deptos = Es el Controlador que buscara -->
				<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>/Deptos"><?php echo $data['page_title']; ?></a></li>
			</ul>
		</div>

		<!-- Sección para incrustar el DataTable, para que muestre los "Departamentos". -->
		<div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="tableDeptos">
                  <thead>
                    <tr>
                      <th>ID</th>                                            
                      <th>Descripcion</th>											
